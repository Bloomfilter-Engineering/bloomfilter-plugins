...
# Devin CLI hands plugin hooks DEVIN_PLUGIN_ROOT and, for Claude-plugin
# compatibility, CLAUDE_PLUGIN_ROOT as well; either names the same directory.
root="${DEVIN_PLUGIN_ROOT:-${CLAUDE_PLUGIN_ROOT:-"$(CDPATH= cd -- "$(dirname -- "$0")/.." && pwd)"}}"
