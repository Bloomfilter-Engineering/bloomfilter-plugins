...
# Devin CLI sets DEVIN_PLUGIN_ROOT for plugin hooks and CLAUDE_PLUGIN_ROOT for
# Claude-plugin compatibility; either names the same directory.
$pluginRoot = $env:DEVIN_PLUGIN_ROOT
if (-not $pluginRoot) {
